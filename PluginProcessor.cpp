...
//==============================================================================
EchoToneTweakerAudioProcessor::EchoToneTweakerAudioProcessor()
...
#endif
{
    ...
    dryWetKnobParameter = new juce::AudioParameterFloat(juce::ParameterID("3", 3), "Dry/Wet", 0.0f, 100.0f, 10.0f);
...
//==============================================================================
const juce::String EchoToneTweakerAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool EchoToneTweakerAudioProcessor::acceptsMidi() const
{
...
bool EchoToneTweakerAudioProcessor::producesMidi() const
{
...
bool EchoToneTweakerAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double EchoToneTweakerAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int EchoToneTweakerAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int EchoToneTweakerAudioProcessor::getCurrentProgram()
{
    return 0;
}

void EchoToneTweakerAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String EchoToneTweakerAudioProcessor::getProgramName (int index)
{
    return {};
}

void EchoToneTweakerAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void EchoToneTweakerAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void EchoToneTweakerAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool EchoToneTweakerAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void EchoToneTweakerAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//    float activeFrequency=0.0;
    ...
    Osc.oscillator(buffer, getSampleRate(), 2);
...
//==============================================================================
bool EchoToneTweakerAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* EchoToneTweakerAudioProcessor::createEditor()
{
    return new EchoToneTweakerAudioProcessorEditor (*this);
}

//==============================================================================
void EchoToneTweakerAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void EchoToneTweakerAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new EchoToneTweakerAudioProcessor();
}
